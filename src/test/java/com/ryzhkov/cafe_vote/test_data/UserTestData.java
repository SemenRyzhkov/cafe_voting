...
public class UserTestData {
    ...
    public static final User admin1 = new User(ADMIN_ID, "Admin_First", "admin@yandex.ru", "admin", Role.ADMIN, Role.USER);
    public static final User admin2 = new User(ADMIN_ID+1, "Admin_Second", "second@yandex.ru", "second", Role.ADMIN, Role.USER);
