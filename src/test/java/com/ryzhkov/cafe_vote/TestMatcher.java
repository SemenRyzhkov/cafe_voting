...
import static com.ryzhkov.cafe_vote.TestUtil.readFromJsonMvcResult;
import static com.ryzhkov.cafe_vote.TestUtil.readListFromJsonMvcResult;
...
public class TestMatcher<T> {
    ...
    public void assertMatch(Map<LocalDate, List<DishDto>> actual, Map<LocalDate, List<DishDto>> expected) {
    ...
    public ResultMatcher contentJson(Map<LocalDate, List<DishDto>> expected) {
        return result -> assertMatch(TestUtil.readMapFromJsonMvcResult(result, clazz), expected);
    }
